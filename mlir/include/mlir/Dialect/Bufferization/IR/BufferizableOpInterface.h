...
struct BufferizationOptions {
  ...
  /// in `scf.for`, branches of `scf.if`, cases of `scf.index_switch`).
  /// `nullptr` keeps the default behavior (promote to fully-dynamic layout
  /// on layout mismatch, fail on memory-space mismatch).
